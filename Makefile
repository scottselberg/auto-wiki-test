# This Makefile is for the Selberg::AutoWikiTest extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Selberg::AutoWikiTest]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Selberg/AutoWikiTest.pm]
...
MAKE = make
FULLEXT = Selberg/AutoWikiTest
BASEEXT = AutoWikiTest
PARENT_NAME = Selberg
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Selberg
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Selberg
...
TO_INST_PM = autoWikiTest.pl \
	lib/Selberg/AutoWikiTest.pm \
	prep.pl

PM_TO_BLIB = prep.pl \
	$(INST_LIB)/Selberg/prep.pl \
	lib/Selberg/AutoWikiTest.pm \
	blib/lib/Selberg/AutoWikiTest.pm \
	autoWikiTest.pl \
	$(INST_LIB)/Selberg/autoWikiTest.pl
...
DISTNAME = Selberg-AutoWikiTest
DISTVNAME = Selberg-AutoWikiTest-1.0.1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Selberg-AutoWikiTest' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires: {}' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: v1.0.1' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Selberg-AutoWikiTest",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "v1.0.1"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  prep.pl $(INST_LIB)/Selberg/prep.pl \
	  lib/Selberg/AutoWikiTest.pm blib/lib/Selberg/AutoWikiTest.pm \
	  autoWikiTest.pl $(INST_LIB)/Selberg/autoWikiTest.pl 
